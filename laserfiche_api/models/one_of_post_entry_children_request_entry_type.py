...
class OneOfPostEntryChildrenRequestEntryType(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfPostEntryChildrenRequestEntryType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfPostEntryChildrenRequestEntryType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfPostEntryChildrenRequestEntryType):
            return False
