...
from laserfiche-api.models.create_entry_operations import CreateEntryOperations  # noqa: E501
...
class TestCreateEntryOperations(unittest.TestCase):
    ...
    def testCreateEntryOperations(self):
        ...
        # model = laserfiche-api.models.create_entry_operations.CreateEntryOperations()  # noqa: E501
        pass
