...
from laserfiche-api.models.put_template_request import PutTemplateRequest  # noqa: E501
...
class TestPutTemplateRequest(unittest.TestCase):
    ...
    def testPutTemplateRequest(self):
        ...
        # model = laserfiche-api.models.put_template_request.PutTemplateRequest()  # noqa: E501
        pass
