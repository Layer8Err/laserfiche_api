...
from laserfiche-api.models.api_server_exception import APIServerException  # noqa: E501
...
class TestAPIServerException(unittest.TestCase):
    ...
    def testAPIServerException(self):
        ...
        # model = laserfiche-api.models.api_server_exception.APIServerException()  # noqa: E501
        pass
