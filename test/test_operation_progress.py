...
from laserfiche-api.models.operation_progress import OperationProgress  # noqa: E501
...
class TestOperationProgress(unittest.TestCase):
    ...
    def testOperationProgress(self):
        ...
        # model = laserfiche-api.models.operation_progress.OperationProgress()  # noqa: E501
        pass
