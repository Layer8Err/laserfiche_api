...
[**get_template_field_definitions_by_template_name**](TemplateDefinitionsApi.md#get_template_field_definitions_by_template_name) | **GET** /v1-alpha/Repositories/{repoId}/TemplateDefinitions/Fields | 

# **get_template_definition_by_id**
> WTemplateInfo get_template_definition_by_id(repo_id, template_id, select=select)
...
try:
    api_response = api_instance.get_template_definition_by_id(repo_id, template_id, select=select)
    pprint(api_response)
...
> ODataValueOfIListOfWTemplateInfo get_template_definitions(repo_id, template_name=template_name, prefer=prefer, select=select, orderby=orderby, top=top, skip=skip, count=count)
...
try:
    api_response = api_instance.get_template_definitions(repo_id, template_name=template_name, prefer=prefer, select=select, orderby=orderby, top=top, skip=skip, count=count)
    pprint(api_response)
except ApiException as e:
...
# **get_template_field_definitions_by_template_name**
> ODataValueOfIListOfTemplateFieldInfo get_template_field_definitions_by_template_name(repo_id, template_name, prefer=prefer, select=select, orderby=orderby, top=top, skip=skip, count=count)
...
try:
    api_response = api_instance.get_template_field_definitions_by_template_name(repo_id, template_name, prefer=prefer, select=select, orderby=orderby, top=top, skip=skip, count=count)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TemplateDefinitionsApi->get_template_field_definitions_by_template_name: %s\n" % e)
```
